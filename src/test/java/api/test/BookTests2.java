...
import api.endpoints.BookEndPoints2;
...
public class BookTests2 {
	...
	public void testPostBook() {
		...
		Response response = BookEndPoints2.createBook(bookPayload);
	...
	public void testGetBook() {
		...
		Response response = BookEndPoints2.readBook(staticUserId);
		response.then().log().all();
	...
	public void testUpdateBook() {
	    ...
	    Response response = BookEndPoints2.updateBook(staticUserId, bookPayload);
	...
	public void testDeleteBook() {
		...
		Response response = BookEndPoints2.deleteBook(staticUserId);
