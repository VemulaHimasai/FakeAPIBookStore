...
public class UserTests2 {
	...
	public void testGetUser() {
		...
		Response response = UserEndPoints2.readUser(staticUserId);
        response.then().log().all();
	...
	public void testUpdateUser() {
        ...
        Response response = UserEndPoints2.updateUser(staticUserId, userPayload);
        response.then().log().all();
        Assert.assertEquals(response.statusCode(), 200);
	...
	public void testDeleteUser() {
		...
		Response response = UserEndPoints2.deleteUser(staticUserId);
        response.then().log().all();
        Assert.assertEquals(response.statusCode(), 200);
